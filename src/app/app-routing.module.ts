...
const routes: Routes = [
  {path: '', component: MainLayoutComponent, children: [
      ...
      {
        path: 'competitions', component: CompetitionsPageComponent, children: [
          {path: ':id', component: CompetitionCalendarPageComponent}
        ]
      },
      {
        path: 'teams', component: TeamsPageComponent, children: [
          {path: ':id', component: TeamCalendarPageComponent}
        ]
      }
    ]}
];
